const TabContent = ({ tabName }) => {
  const tabData = {
    ...
    experience: "Currently working at Yodo Design as a React.js developer with 2 years of professional experience.\n Skilled in building responsive and dynamic user interfaces, collaborating with cross functional \n teams, and translating complex designs into seamless web experiences.Experienced in optimizing \n frontend performance, implementing best practices, and actively contributing to team workflows while \n maintaining a growth mindset and focus on UI excellence.",
